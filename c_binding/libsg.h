...
#define _T10_SPC_REQUEST_SENSE_MAX_LEN              0xffff
 ...
 *  None
 */
LSM_DLL_LOCAL int32_t _sg_smart_interpret_asc(uint8_t asc);
 ...
 *  smart_status != NULL
 */
LSM_DLL_LOCAL int _sg_sas_smart_status(char *err_msg, int fd,
 ...
 *  smart_status != NULL
 */
LSM_DLL_LOCAL int _sg_ata_passthrough_smart_status(char *err_msg, int fd,
                                                   int32_t *smart_status);
