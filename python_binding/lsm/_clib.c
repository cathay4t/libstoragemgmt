...
static const char local_disk_smart_status_get_docstring[] =
    "INTERNAL USE ONLY!\n"
    "\n"
    "Usage:\n"
    "    Query the SMART Status of a given disk path\n"
    "Parameters:\n"
    "    disk_path (string)\n"
    "        The SCSI disk path, example '/dev/sdb'. Empty string is failure\n"
    "Returns:\n"
    "    [smart_status, rc, err_msg]\n"
    "        smart_status (int)\n"
    "            SMART Status.\n"
    "        rc (integer)\n"
    "            Error code, lsm.ErrorNumber.OK if no error\n"
...
static PyObject *local_disk_vpd83_get(PyObject *self, PyObject *args,
                                      PyObject *kwargs);
static PyObject *local_disk_smart_status_get(PyObject *self, PyObject *args,
                                             PyObject *kwargs);
...
static PyMethodDef _methods[] = {
    ...
    {"_local_disk_smart_status_get",  (PyCFunction) local_disk_smart_status_get,
     METH_VARARGS | METH_KEYWORDS, local_disk_smart_status_get_docstring},
...
_wrapper(local_disk_vpd83_get, lsm_local_disk_vpd83_get,
         const char *, disk_path, char *, NULL,
         _c_str_to_py_str, free);
_wrapper(local_disk_smart_status_get, lsm_local_disk_smart_status_get,
         const char *, disk_path, int32_t, LSM_DISK_SMART_STATUS_UNKNOWN,
